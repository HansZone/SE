...
(function($) {
    ...
    $.fn.waterwheelCarousel.defaults = {
        startingItem:               10,      // item to place in the center at the start
        startingItemSeparation:     100,    // the starting separation distance between each item
        itemSeparationFactor:       .5,     // determines how drastically the item separation decreases
        startingWaveSeparation:     10,      // the starting separation distance for the wave
