...
class RSI{
    ...
    public function Analysis($index){
        if ($index<30) echo "It's likely oversold. Suggestion: BUY.";
        if ($index>=30 && $index<70) echo " It's safe area. Suggestion: HOLD OR SIT OUT.";
        if ($index>=70) echo "It's likely overbought. Suggestion: SELL.";
    }
}
?>
