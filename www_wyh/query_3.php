    ...
    <div class="content">
        ...
        <div class="page-header">
            ...
            <ul class="page-header-actions">
                ...
                <li class="active demoTabs"><a href="query_3.php" class="btn btn-wuxia">4.Get lowest</a></li>
                <li class="demoTabs"><a href="query_4.php" class="btn btn-wuxia">5.Get smaller</a></li>
            </ul>
        </div>
        <!-- /Page header -->
        ...
        <!-- Tab #flot3 -->
        <div class="tab-pane active" id="flot3">
