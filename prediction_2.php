			...
			<div class="content">
				...
				<div class="page-header">
					...
					<ul class="page-header-actions">
						<li class="demoTabs"><a href="http://localhost/Prediction.php" class="btn btn-wuxia">Indicator</a></li>
						<li class="demoTabs"><a href="#flot1" class="btn btn-wuxia">Price</a></li>
						<li class="active demoTabs"><a href="#flot2" class="btn btn-wuxia">Prediction Strategy</a></li>
					</ul>
